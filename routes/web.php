...
Route::get('/images-admin/{filename}', function ($filename) {
    $path = public_path('images-admin/'.$filename);
...
Route::get('/jurnal/{filename}', function ($filename) {
    $path = public_path('jurnal/'.$filename);
...
Route::get('/tugas/{filename}', function ($filename) {
